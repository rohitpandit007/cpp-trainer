...
const rows = [
 ...
 ['member-functions','Inside and outside class functions','Move a function definition outside.','You may write a member function in the class, or define it later using ClassName::.','Define show() outside a Book class.','Make a Rectangle class with area().','Create an Invoice class with separate member definitions.'],
 ...
 ['friends','Friend functions & classes','Give a trusted function access.','A friend is not a member, but the class explicitly allows it to see private data.','Use a friend to print a Box width.','Compare two private values with a friend.','Use a friend function for complex-number addition.'],
 ['constructors','Constructors','Initialize objects automatically.','A constructor runs when an object is created. It gives every object a good starting state.','Add a default constructor.','Add a parameterized constructor.','Create a class using dynamic memory, copy constructor, and destructor.'],
 ...
 ['abstract','Virtual bases & abstract classes','Define a shared contract.','An abstract class has a pure virtual function. Virtual base classes avoid duplicate base copies in diamond inheritance.','Make abstract Shape with area().','Create Circle and Rectangle.','Use virtual inheritance in a diamond hierarchy.'],
 ['derived-constructors','Derived constructors','Build base first, then derived.','A derived constructor calls its base constructor before setting its own members.','Call a Person constructor from Student.','Initialize several base values.','Build an employee hierarchy with correct constructor chaining.'],
 ...
 ['operators','Unary, binary & friend operators','Make objects behave like values.','Unary operators use one value; binary operators use two. Friend operators are useful when the left value is not your class.','Overload unary - for Temperature.','Overload + for Complex.','Use a friend function for operator overloading.'],
 ...
 ['string-operators','String manipulation operators','Join custom strings.','Operator overloading can make a custom string class join, compare, and display text.','Overload + for two small strings.','Overload == to compare them.','Create a dynamic String class with concatenation.'],
